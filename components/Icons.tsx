...
/** Stroke-style icon wrapper (Lucide defaults). */
function Stroke({
  size = 24,
  className,
  children,
...
/** Fill-style icon wrapper (brand / social icons). */
function Fill({
  size = 24,
  className,
  children,
...
export const Leaf = (p: IconProps) => (
  <Stroke {...p}>
    <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96a1 1 0 0 1 1.8.66c0 11.05-5.71 16.38-10 16.38z" />
